...
module "storage_account" {
  source = "git::git@github.com:pagopa/io-infrastructure-modules-new.git//azurerm_storage_account?ref=update-azurerm-version-2.78.0"
...
module "storage_account_durable_function_private_endpoint_blob" {
  count  = var.durable_function.enable ? 1 : 0
  source = "git::git@github.com:pagopa/io-infrastructure-modules-new.git//azurerm_private_endpoint?ref=update-azurerm-version-2.78.0"
